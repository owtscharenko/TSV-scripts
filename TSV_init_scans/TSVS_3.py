...
if __name__ == "__main__":   
    ...
    runmngr.run_run(AnalogScan, run_conf={'scan_parameters': [('PlsrDAC', target_charge)], "mask_steps": mask })
#     runmngr.run_run(run=AnalogScan, run_conf={'scan_parameters': [('PlsrDAC', target_charge)],"mask_steps": mask })  # heat up the Fe a little bit for PlsrDAC scan
